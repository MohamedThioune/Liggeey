...
export class HomePageService {
  ...
  applyJob(idUser: number,idJob:number): Observable<any> { 
    ...
    return this.http.post<any>(`http://wp12.influid.nl/wp-json/custom/v1/apply/`,requestBody);
  }
  ...
  manageJob(id: number): Observable<any> { 
    return this.http.post<any>(`http://wp12.influid.nl/wp-json/custom/v1/user/jobs/?userApplyId=${id}`,{});
  }
  postNewJob(id: number): Observable<any> { 
    return this.http.post<any>(`http://wp12.influid.nl/wp-json/custom/v1/user/jobs/?userApplyId=${id}`,{});
  }
  getApplicantUser(id: number): Observable<any> { 
    return this.http.post<any>(`http://wp12.influid.nl/wp-json/custom/v1/user/applicants/?userApplyId=${id}`,{});
  }
  getCandidatCompagny(id: number): Observable<any> { 
    return this.http.post<any>(`http://wp12.influid.nl/wp-json/custom/v1/user/favorites/?userApplyId=${id}`,{});
  }
  homeCompagny(id: number): Observable<any> { 
    return this.http.post<any>(`http://wp12.influid.nl/wp-json/custom/v1/user/home/?userApplyId=${id}`,{});
  }
}
