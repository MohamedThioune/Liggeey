...
@Component({
  selector: 'app-item-all-job',
  templateUrl: './item-all-job.component.html',
  styleUrls: ['./item-all-job.component.css']
})
export class ItemAllJobComponent implements OnInit {
