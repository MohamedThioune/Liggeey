...
@Component({
  selector: 'app-badge-candidat',
  templateUrl: './badge-candidat.component.html',
  styleUrls: ['./badge-candidat.component.css']
})
export class BadgeCandidatComponent implements OnInit {
