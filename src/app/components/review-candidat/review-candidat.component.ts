...
@Component({
  selector: 'app-review-candidat',
  templateUrl: './review-candidat.component.html',
  styleUrls: ['./review-candidat.component.css']
})
export class ReviewCandidatComponent implements OnInit {
