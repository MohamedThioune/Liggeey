...
@Component({
  selector: 'app-certificat-candidat',
  templateUrl: './certificat-candidat.component.html',
  styleUrls: ['./certificat-candidat.component.css']
})
export class CertificatCandidatComponent implements OnInit {
