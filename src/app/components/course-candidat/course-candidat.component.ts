...
@Component({
  selector: 'app-course-candidat',
  templateUrl: './course-candidat.component.html',
  styleUrls: ['./course-candidat.component.css']
})
export class CourseCandidatComponent implements OnInit {
